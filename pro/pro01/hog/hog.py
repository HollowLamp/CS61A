...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        return False
    k = gcd(player_score, opponent_score)
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    return True if (player_score < opponent_score) and (opponent_score -player_score < 3) else False
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if tmp > running_high:
                print(tmp,"point(s)! The most yet for Player",who)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if free_bacon(opponent_score) >= cutoff or extra_turn(score + free_bacon(opponent_score), opponent_score) else num_rolls  # Replace this statement
    # END PROBLEM 11
