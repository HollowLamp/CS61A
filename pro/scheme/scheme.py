...
class Frame(object):
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 2
        "*** YOUR CODE HERE ***"
        if not symbol in self.bindings.keys():
            if self.parent:
...
class LambdaProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        fra = self.env.make_child_frame(self.formals, args)
        return fra
...
# From https://github.com/PKUFlyingPig/CS61A/blob/master/projects/scheme/scheme.py
...
class MuProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        """Make a frame that binds my formal parameters to ARGS, a Scheme list
        of values, for a lexically-scoped call evaluated in environment ENV."""
        fra = env.make_child_frame(self.formals, args)
        return fra
    # END PROBLEM 18
