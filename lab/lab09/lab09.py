def insert_into_all(item, nested_list):
    ...
    [[0], [0, 1, 2], [0, 3]]
    """
    return [[item] + it for it in nested_list]
...
def make_advanced_counter_maker():
    ...
    def make_counter():
        private_count = 0
        def counter(message):
            nonlocal global_count, private_count
            if message == 'count':
                private_count += 1
