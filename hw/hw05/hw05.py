class VendingMachine:
    ...
    def vend(self):
        ...
        ans = 'Here is your {0}'.format(self.item)
        if diff != 0:
            ans += ' and ${0} change'.format(-diff)
        self.balance = 0
        self.stock -= 1
        return ans + '.'
...
def is_bst(t):
    ...
    if len(t.branches) == 1:
        ...
        return is_bst(t.branches[1]) and is_bst(t.branches[0]) and bst_min(t.branches[1]) > t.label and bst_max(t.branches[0]) <= t.label
    else:
        return False
